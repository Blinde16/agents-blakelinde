...
from src.orchestration.db_pool import get_pool, run_with_pool
import asyncio
import fire
...
def client_margin(client_name: str, db_url: str = "") -> str:
    return asyncio.run(run_with_pool(get_client_margin(client_name, db_url)))

def revenue_summary(timeframe: str, db_url: str = "") -> str:
    return asyncio.run(run_with_pool(get_revenue_summary(timeframe, db_url)))
